...
sf org login jwt -o $USER_NAME  -f $SERVER_KEY -i "3MVG9JgJamLaOK52YAPdElwPr.x52bQjcB9h_wJFbU6svmTnVSXyYlAgpHWG17xudTms0oON6ga1mLGYcvKM5" -r https://test.salesforce.com -a $SANDBOX_NAME
set +x
